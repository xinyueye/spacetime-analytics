MathRandom=function(){return Math.random();};
DateGetTime=function(){return new Date().GetTime();};
...
function SSOController(){
	...
	this.init=function(){
		...
		me.isGenerateVisitor&&self===top&&MathRandom()<me.generateVisitorProbability&&location.protocol!=="https:"&&setTimeout(me.name+".generateVisitor()",me.generateVisitorDelay*1e3);
	...
	(function(){
		var a=function(){},b={
			username:"",password:"",savestate:0,vsnf:0,vsnval:"",door:"",setCookie:1,ssoSimpleLogin:0,onComplete:a,onSuccess:a,onFailure:a
		}
		,c={
			onComplete:a,onSuccess:a,onFailure:a
		}
		,d={
			vsnf:"vsnf",vsnval:"vsnval",door:"door",setCookie:"s",ssoSimpleLogin:"ssosimplelogin"
		}
		,e={},f={},g=function(a,b){
			var c,d={};
			a=a||{};
		...
		customPrepare=function(a){
			...
			a=a||{};
			e=objMerge({
				entry:"sso",useTicket:!1,service:"sso",domain:"sina.com.cn",feedBackUrl:"",setDomain:!1,crossDomain:!0,name:"sinaSSOController"
			}
			,b);
			e=g(e,a);
	...
	this.login=function(a,b,c){
		...
		ssoLoginTimer.start(me.loginTimeout,function(){
			...
			me.callbackLoginStatus({
				result:!1,errno:-1,reason:unescape("%u767B%u5F55%u8D85%u65F6%uFF0C%u8BF7%u91CD%u8BD5")
			})
		});
		c=c==undefined?0:c;
		tmpData.savestate=c;
	...
	this.prelogin=function(a,b){
		...
		delete a.username;
		var e={
			entry:me.entry,callback:me.name+".preloginCallBack",su:d,rsakt:"mod"
		};
		...
		me.preloginCallBack=function(a){
			if(a&&a.retcode==0){
				...
				me.rsakv=a.rsakv;
				pcid=a.pcid;
				preloginTime=DateGetTime()-preloginTimeStart-(parseInt(a.exectime,10)||0)
			}
			typeof b=="function"&&b(a)
		};
		preloginTimeStart=DateGetTime();
		excuteScript(me.scriptId,c)
	};
	this.getServerTime=function(a,b){
		if(me.servertime){
			typeof b=="function"&&b({
				retcode:0,servertime:me.servertime
			});
			return!0
		}
		me.prelogin({
	...
	this.logout=function(){
		try{
			...
			var a={
				entry:me.getEntry(),callback:me.name+".ssoLogoutCallBack"
			};
			try{
				a.sr=window.screen.width+"*"+window.screen.height
			}
			catch(b){}var c=location.protocol=="https:"?ssoLogoutUrl.replace(/^http:/,"https:"):ssoLogoutUrl;
			c=makeURL(c,a);
			excuteScript(me.scriptId,c)
		}
		catch(b){}return!0
	...
	this.updateCookie=function(){
		try{
			...
			var a=me.getCookieExpireTime(),b=DateGetTime()/1e3,c={};
			a==null?c={
				retcode:6102
			}
			:a<b?c={
			...
			d=makeURL(d,{
				entry:me.getEntry(),callback:me.name+".updateCookieCallBack"
			});
			...
			if(d){
				...
				if(me.feedBackUrl)me.crossDomain?me.crossDomainAction("login",function(){
					...
					a.crossDomainUrlList&&me.setCrossDomainUrlList({
						retcode:0,arrURL:a.crossDomainUrlList
					});
	...
	this.crossDomainAction=function(a,b){
		...
		var d={
			scriptId:me.ssoCrossDomainScriptId,callback:me.name+".crossDomainCallBack",action:a,domain:c,sr:window.screen.width+"*"+window.screen.height
		}
	...
	this.checkLoginState=function(a){
		a?me.autoLogin(a):me.autoLogin(function(a){
			...
			if(a!==null){
				var c={
					displayname:a.nick,uniqueid:a.uid,userid:a.user
				};
				b.result=!0;
				b.userinfo=c
			}
	...
	this.getSinaCookie=function(a){
		...
		if(!b)return null;
		var c=parse_str(b);
		return a&&c.et&&c.et*1e3<DateGetTime()?null:c
	};
	...
	this.appLogin=function(a,b,c){
		var d=tmpData.savestate?parseInt(DateGetTime()/1e3+tmpData.savestate*86400):0,e=getCookie("ALF")?getCookie("ALF"):0,f={
			callback:c,ticket:a,ssosavestate:d||e
		}
	...
	this.getPinCodeUrl=function(a){
		...
		return b+"?r="+Math.floor(MathRandom()*1e8)+"&s="+a+(pcid.length>0?"&p="+pcid:"")
	};
	...
	var makeNonce=function(a){
		...
		for(var d=0;d<a;d++)c+=b.charAt(Math.ceil(MathRandom()*1e6)%b.length);
		return c
	}
	,sinaAutoLogin=function(a){
		autoLoginCallBack2=a;
		var b={
			entry:me.getEntry(),service:me.service,encoding:"UTF-8",gateway:1,returntype:"TEXT",from:me.from
		};
		if(me.domain=="sina.com.cn"){
	...
	,excuteScript=function(a,b,c){
		...
		e.src=makeURL(b,{
			client:me.getClientType(),_:DateGetTime()
		});
		d.appendChild(e)
	}
	...
	,makeRequest=function(a,b,c){
		var d={
			entry:me.getEntry(),gateway:1,from:me.from,savestate:c,useticket:me.useTicket?1:0
		};
	...
	,makeXMLRequestQuery=function(a,b,c){
		...
		return objMerge(e,{
			encoding:"UTF-8",cdult:d,domain:me.domain,useticket:me.appLoginURL[me.domain]?1:0,prelt:preloginTime,returntype:"TEXT"
		})
	}
	...
	,loginByIframe=function(a,b,c){
		...
		if(me.feedBackUrl){
			e.url=makeURL(me.feedBackUrl,{
				framelogin:1,callback:"parent."+me.name+".feedBackUrlCallBack"
			});
			e.returntype="META"
		}
		else{
...
(function(){
	...
	this.getSUBPCookie={
		...
		,decode:function(a){
			...
			switch(d){
				case"002":b=sinaSSOEncoder.base64.decode(e,"subp_v2","array");
				return sinaSSOEncoder.getSUBPCookie.__parse(b);
				case"003":c=e.substr(0,1);
...
if(bd==null){
	...
	while(be<bb){
		bh=Math.floor(65536*MathRandom());
		bd[be++]=bh>>>8;
		bd[be++]=bh&255
	}
	be=0;
