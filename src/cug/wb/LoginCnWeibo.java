...
//import net.sf.json.JSONObject;
 public class LoginCnWeibo
 {
    ...
    public LoginCnWeibo(String username,String password){
    ...
    public boolean preLogin(){
        ...
        try {
            ...
            url += "&su="+su;
            org.apache.log4j.Logger.getLogger("weibo").info("su="+su);
            String content;
            ...
            org.apache.log4j.Logger.getLogger("weibo").info(json);
    ...
    public static String postRequest(HttpClient client,String url,List<NameValuePair> parms,String cookieString) throws ClientProtocolException, IOException{
        HttpPost post = new HttpPost(url);
        post.addHeader("User-Agent", "Mozilla/5.0 (Linux; U; Android 4.3; en-us; SM-N900T Build/JSS15J) AppleWebKit/534.30 (KHTML, like Gecko) Version/4.0 Mobile Safari/534.30");
        post.addHeader("Content-Type", "application/x-www-form-");
        post.addHeader("Accept","*/*");
       // post.addHeader("Accept-Encoding","gzip,deflate,sdch");
        post.addHeader("Accept-Language","zh-CN,zh;q=0.8");
//        post.addHeader("Connection","keep-alive");
        if(cookieString!=null )
        	post.setHeader("Cookie", "_T_WM=d904b6adafe3a4fc642913e84a154e18; USER_LOGIN_VERSION=1; _TTT_USER_CONFIG_H5=%7B%22ShowMblogPic%22%3A1%2C%22ShowUserInfo%22%3A1%2C%22MBlogPageSize%22%3A%2250%22%2C%22ShowPortrait%22%3A1%2C%22CssType%22%3A0%2C%22Lang%22%3A1%7D");
//        post.setHeader("Host","passport.sina.cn");
//        post.setHeader("Origin","https://passport.sina.cn");
//        post.setHeader("Referer","https://passport.sina.cn/signin/login?entry=mweibo&res=wel&wm=3349&r=http%3A%2F%2Fm.weibo.cn%2F");
    ...
    public boolean getContent(){
           String url = "http://weibo.cn/search/mblog?hideSearchFrame=&keyword=pm2.4&page=2";
           HttpPost post = new HttpPost(url);
      
           RequestParams rp=new RequestParams();
           rp.getFromConfig("config\\cn.weibot");
           rp.setHeader(post);         
           rp.setpostEntiy(post,rp.formData);
...
//         
           ...
           /*EntityUtils.consume(entity);*/
                ...
                String s=CharsetTranslate.unicodeToUtf8(content);
                ...
                if(m.find()){
                    ...
                    if(location.contains("reason=")){
                        ...
                        org.apache.log4j.Logger.getLogger("weibo").info("result--------------"+result);
                        return true;
                    }
                }
            } catch (ClientProtocolException e) {
...
//          org.apache.log4j.Logger.getLogger("weibo").info(MyUrlUtil.getResource(url));
    ...
    public boolean login(){
           String url = "https://login.weibo.cn/login/?rand=1176154935&backURL=http%3A%2F%2Fweibo.cn%2F&backTitle=%E5%BE%AE%E5%8D%9A&vt=4&revalid=2&ns=1";
      List<NameValuePair> parms = new ArrayList<NameValuePair>();
            parms.add(new BasicNameValuePair("password_6392", "weibo20140w718"));
            parms.add(new BasicNameValuePair("backTitle", "微博"));
            parms.add(new BasicNameValuePair("remember", "on"));
            parms.add(new BasicNameValuePair("mobile", "lsw4000@163.com"));            
            parms.add(new BasicNameValuePair("vk", "6392_d356_2045284469"));
            parms.add(new BasicNameValuePair("submit", "登录"));
            parms.add(new BasicNameValuePair("backURL", "http%3A%2F%2Fweibo.cn%2F"));
            
            
      
           
            try {
            	org.apache.log4j.Logger.getLogger("weibo").info("sp="+sp);
                 String content = postRequest(client, url, parms,null);
...
//          org.apache.log4j.Logger.getLogger("weibo").info(MyUrlUtil.getResource(url));
    ...
    private boolean encodePwd(){
     ...
     //       String callbackvalue = (String) invocableEngine.invokeFunction("getpass",pubkey,servertime,nonce,password);
            String callbackvalue = (String) invocableEngine.invokeFunction("getpass",password,servertime,nonce,pubkey);
    ...
    private long getTimestamp(){
     ...
     public String testSp()  
     {
    	 ...
    	 this.servertime=Long.parseLong("1405861739");
    	 this.nonce="GEKQ2I";
    	 this.rsakv="1405944278";
    //	 String key=RSAUtils.s
    	 
    	 this.pubkey="";
    	 this.password="12345";
    	 String data=servertime+ '\t' + nonce + '\n' + password;
    	 preLogin();
//    	try {
//			byte bytes[]= RSAUtils.encryptByPublicKey(data.getBytes(), pubkey);
//			org.apache.log4j.Logger.getLogger("weibo").info(Base64Utils.encode(bytes));
//		} catch (Exception e) {
//			// TODO Auto-generated catch block
//			e.printStackTrace();
//		}
//    	
    	 ...
    	 this.encodePwd();
    	 org.apache.log4j.Logger.getLogger("weibo").info(sp);
...
//    	LoginDog weibo = new LoginDog("lsw4000@163.com", "lsw4000@163.com");
//    	weibo.testSp();
    
    	LoginCnWeibo weibo = new LoginCnWeibo("lsw4000@163.com", "weibo20140718");
    	weibo.getContent();
//    	LoginDog weibo = new LoginDog("lsw4000@163.com", "weibo20140718");
//        if(weibo.login()){
//            org.apache.log4j.Logger.getLogger("weibo").info("登陆成功！");
//            
//            String url = "http://www.weibo.com/hm";
////          String source = MyUrlUtil.getResource(url);
////          org.apache.log4j.Logger.getLogger("weibo").info(source);
//        }else{
//            org.apache.log4j.Logger.getLogger("weibo").info("登录失败！");
//        }
    }
    public String getJsold()
    {
